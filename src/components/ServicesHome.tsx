    ...
    },
    {
      ...
      label:
        language === "en"
          ? "Book a Clean-up"
          : language === "si"
            ? "පිරිසිදු කිරීමක් වෙන් කරවා ගන්න"
            : "சுத்தம் செய்ய முன்பதிவு செய்யுங்கள்",
      link: "/services",
    },
    {
      icon: DollarSign,
